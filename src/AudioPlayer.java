        ...
        playbackThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    JOptionPane.showMessageDialog(AudioPlayer.this,
                           "Audio format is not supported !", "Error!", JOptionPane.ERROR_MESSAGE);
                    resetControls();
                    ex.printStackTrace();
                } catch (LineUnavailableException ex) {
                    JOptionPane.showMessageDialog(AudioPlayer.this,
                            "Unable to play audio file!", "Error!", JOptionPane.ERROR_MESSAGE);
                    resetControls();
                    ex.printStackTrace();
                } catch (IOException ex) {
                    JOptionPane.showMessageDialog(AudioPlayer.this,
                            "I/O error при воспроизведении аудиофайла!", "Ошибка", JOptionPane.ERROR_MESSAGE);
                    resetControls();
                    ex.printStackTrace();
                }
